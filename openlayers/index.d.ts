...
declare module olx {
    ...
    interface OverlayPanOptions {
         ...
         * @type {number}
         * @memberOf OverlayPanOptions
         */
        duration?: number;
        /**
         * The easing function to use. Can be an ol.easing or a custom function.
         * Default is ol.easing.inAndOut.
         * 
         * @memberOf OverlayPanOptions
         */
    ...
    module source {
        ...
        interface ImageArcGISRestOptions {
            ...
            crossOrigin?: (string);
            /**
             * Use the @see {@link ol.Map#pixelRatio } value when requesting the image from the remote server. Default is true.
             * @default {true}
             * @type {boolean}
             * @memberOf ImageArcGISRestOptions
             */
            hidpi?: boolean;
            logo?: (string | olx.LogoOptions);
            imageLoadFunction?: ol.ImageLoadFunctionType;
        ...
        interface ZoomifyOptions {
             ...
             *  A base URL is the fixed part of the URL, excluding the tile group, z, x, and y folder structure,
             *  e.g. http://my.zoomify.info/IMAGE.TIF/. 
             *  A URL template must include {TileGroup}, {x}, {y}, and {z} placeholders,
             *  e.g. http://my.zoomify.info/IMAGE.TIF/{TileGroup}/{z}-{x}-{y}.jpg. 
             *  A {?-?} template pattern, for example subdomain{a-f}.domain.com, may be used instead of
             ...
             * 
             * @type {("default" | "truncated")}
             * @memberOf ZoomifyOptions
             */
    ...
    module view {
        interface FitOptions {
             ...
             * Default is the current size of the first map in the DOM that uses this view, 
             * or [100, 100] if no such map is found.
             * 
             * @type {ol.Size}
             * @memberOf FitOptions
             */
            ...
            duration?: number;
            /**
             * The easing function used during the animation (defaults to @see {@link ol.easing.inAndOut}). 
             * The function will be called for each frame with a number representing a fraction of the animation's duration. 
             * The function should return a number between 0 and 1 representing the progress toward the destination state.
             * 
             * @memberOf FitOptions
             */
            easing?: (t: number) => number;
